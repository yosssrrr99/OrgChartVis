...
export const horizontalMenuItems = [ 
    ...
    new Menu (10, 'Recruitment Budget', null, null, null, true, 0),  
    new Menu (63, 'Add Envelope', '/contact', null, null, false, 10),  
    new Menu (63, 'Update Envelope', '/update', null, null, false, 10),  
    new Menu (63, 'Validate Envelope', '/validate', null, null, false, 10),  
    new Menu (63, 'Envelope History', '/history', null, null, false, 10),  
    new Menu (64, '404 Page', '/404', null, null, false, 10),  
    new Menu (70, ' Org Chart', '/org', null, null, false, 0),  
